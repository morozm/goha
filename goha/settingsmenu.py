...
class Settingsmenu:
    ...
    def _init(self):
        ...
        self.button_save_rect =     pygame.Rect((WIDTH - self.button_width) // 2 - self.button_width // 2 - self.button_spacing, self.button_start_y, self.button_width, self.button_height)
    ...
    def draw_settings_menu(self):
        ...
        self.draw_username_field            (self.win, self.username_input_text,                                                    WIDTH // 2 + self.options_spacing_horizontal // 2, self.options_start_y,                                                                                                    self.options_input_length, self.options_height, self.theme['maincolor2'], self.theme['maincolor1'], self.theme['maincolor1'], self.username_input_active)
        self.draw_theme_field               (self.win, self.language['Themes'][THEMES_LIST.index(self.theme_select_text)],          WIDTH // 2 + self.options_spacing_horizontal // 2, self.options_start_y + 1 *   (self.options_height + self.options_spacing),                                               self.options_input_length, self.options_height, self.theme['maincolor2'], self.theme['maincolor1'])
        self.draw_language_field            (self.win, self.language['Languages'][LANGUAGES_LIST.index(self.language_select_text)], WIDTH // 2 + self.options_spacing_horizontal // 2, self.options_start_y + 2 *   (self.options_height + self.options_spacing),                                               self.options_input_length, self.options_height, self.theme['maincolor2'], self.theme['maincolor1'])
        self.draw_stone_centering_checkbox  (self.win,                                                                              WIDTH // 2 + self.options_spacing_horizontal // 2, self.options_start_y + 3 *   (self.options_height + self.options_spacing),                                               self.options_height,                            self.theme['maincolor2'], self.theme['maincolor1'])            
        self.draw_slider                    (self.win,                                                                              WIDTH // 2 + self.options_spacing_horizontal // 2, self.options_start_y + 4.5 * (self.options_height + self.options_spacing) - self.slider_height // 2 - self.knob_radius,  self.options_input_length, self.slider_height,  self.theme['maincolor2'], self.theme['maincolor1'], self.theme['maincolor1'], self.knob_dragging)

        mouse_x, mouse_y = pygame.mouse.get_pos()
        self.is_save_hovered = self.button_save_rect.collidepoint(mouse_x, mouse_y)
            ...
            if event.type == pygame.QUIT:
                ...
                if self.language_input_rect.collidepoint(event.pos):
                    try:
                        ...
                        self.language = LANGUAGES[self.language_select_text]
                    except ValueError:
